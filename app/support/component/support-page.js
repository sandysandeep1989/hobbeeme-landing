...
export default function SupportPage() {
  ...
  return (
     <div className={styles.accountPage}>
        ...
        <div className={`${styles.inputGroup} ${styles.inputGroupofSupp}`}>
          <label>Subject</label>
        ...
        <div className={styles.inputGroup}>
          {/* <label>Message</label> */}
          <textarea className={styles.supportTextArea} type="text" name="message" placeholder="Enter your Message" value={formData.message} onChange={handleChange} />
          {errors.message && <span className={styles.error}>{errors.message}</span>}

        </div>
        <button type='submit' className={`${styles.updateBtn} ${styles.submitReqBtn}`}> Submit Request</button>
