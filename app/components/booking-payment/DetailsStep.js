...
import DateInput from '../custom-daypicker/DateInput';
import Dropdown from '../dropdown/Dropdown';
export default function DetailStep({ currentStep, setCurrentStep }) {
  ...
  const [newMember, setNewMember] = useState({ name: '', email: '', role: '', dob: '' });
              ...
              <div>
                <div className={styles.memberGrid}>
                  {members.map((member) => (
                    ...
                    >
                      <div
                        className={`${styles.card} ${selected === member.id ? styles.selectedCard : ''
                          }`}
                      >
                        <div className={styles.cardFlex}>
                          <div>{selected === member.id && (
