...
import CustomDropDown from './CustomDropDwon'
...
//             <Image src='/profile-account.png' width={80} height={80} alt='' />
//             </div>
...
//         <button type="button" className={styles.quizBtn}>Save</button>
...
// }
  ...
  export const EditInfo = () => {
    ...
    // Helper function to capitalize first letter and add space before capitals
    ...
    return (
        <div className={styles.accountPage}>
            ...
            <form className={`${styles.form} ${styles.Editform} `} onSubmit={handleProfileSubmit} noValidate>
                <div className={styles.header}>
                    <div className={styles.profileHolder}>
                        <div className={styles.ProfilePic}>
                            <svg width="21" height="24" viewBox="0 0 21 24" fill="none" xmlns="http://www.w3.org/2000/svg">
